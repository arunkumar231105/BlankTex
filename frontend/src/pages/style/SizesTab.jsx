...
const specFields = [
  { name: 'chest_width', label: 'Chest Width (in)', type: 'number' },
  { name: 'body_length', label: 'Body Length (in)', type: 'number' },
  { name: 'sleeve_length', label: 'Sleeve Length (in)', type: 'number' },
  { name: 'shoulder_width', label: 'Shoulder Width (in)', type: 'number' },
...
const columns = [
  ...
  { key: 'chest_width', label: 'Chest', render: (r) => (r.chest_width ?? '—') },
  { key: 'body_length', label: 'Length', render: (r) => (r.body_length ?? '—') },
